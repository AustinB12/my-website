...
const posts: Blog_Post[] = [
	...
	},
	{
		...
		title: "C# Data Types",
		date: "2026-03-08",
		description: "A quick overview of the data types in C#",
		tags: ["C#", "Programming"],
		component: lazy(() => import("./csharp_datatypes")),
		wordCount: 500
	},
	{
		slug: "csharp-linq",
		...
		tags: ["C#", "Programming"],
		component: lazy(() => import("./csharp_linq")),
		wordCount: 500
	},
	{
		slug: "csharp-collection-types",
		title: "Collection types in C#",
		date: "2026-03-08",
		description: "Collection types in C#",
		tags: ["C#", "Programming"],
		component: lazy(() => import("./csharp_collection_types")),
		wordCount: 500
	},
	{
		slug: "csharp-lists",
		title: "Lists in C#",
		date: "2026-03-08",
		description: "All things LIST",
		tags: ["C#", "Programming"],
		component: lazy(() => import("./csharp_list")),
		wordCount: 500
	}
];
